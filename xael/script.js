...
$(function() {
    ...
     var h = d.getHours(); 
     ...
     10>t?t="0"+t:t=t;
     12>h?time=h+":"+t+" am":time=(h-12)+":"+t+" pm";
     var hello=["HELLO","HI","HEY THERE","HEY","HI XEAL","HELLO XEAL","HEY THERE","HEY XEAL"];
     var gm=["GM","GOOD MORNING","GOOD MORNING Xael", "GOOD MORNING Xael"];
     var bad=["BAD","NOT BAD","USELESS","NOT WORKING","NOT GOOD"];
     var ge=["GOOD EVNG","GOOD EVENING","GOOD EVENING Xael","GOOD EVENING Xael"];
     ...
     var gaf=["GOOD AFTERNOON","GOOD AFTERNOON Xael","GOOD AFTERNOON Xael" ];
     var like=["GOOD","👍🏻", "☺️","😅","LOL","ME TOO"];
     var hru=["HOW R U?","H R U?", "HOW ARE YOU?", "HRU?","HRU", "HOW R U","H R U", "HOW ARE YOU"];
     var good=["I'M GOOD","I'M FINE", "I'M FINE U", "I AM FINE","I'M FINE AND HOW ARE YOU", "MEE TOO", "FINE","FINE:)","FINE :)", "MARVELOUS","AWESOME","FINE☺️","GREAT","I'M FINE, HOW ARE YOU?","IM FINE","IM GOOD","IM AWESOME"];
     ...
     var wrud=["WHAT R U DOING?","WHAT ARE YOU DOING?", "WHAT'S UP", "WHAT'S UP GIRL","WHAT ARE YOU DOING","WRU DOING","WHAT DOING","WT DOING"];
      ...
      var wcu=["WHO CREATED YOU",'WHO IS YOUR CREATOR',"WHO CREATED YOU?",'WHO IS YOUR CREATOR?'];
     function isInArray(x, y) { return x.indexOf(y) > -1; }
    isInArray(hello, lastmsg)==true?(smsg="Hello I'm Xeal, How are you? 😊", k="Hello I'm Xeal, How are you? "):
    ...
    (smsg="Sorry, I didn't understand");
