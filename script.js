...
class Sound{
    constructor(listenerParent){
        ...
        audioLoader.load( 'audios/shred.mp3', buffer =>{
        ...
        audioLoader.load( 'audios/splash.mp3', buffer =>{
